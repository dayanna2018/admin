@extends('layouts.sipsa') @section('main')
<div class="container mt-5 p-5">
    <main>
        <div class="container my-5">
            <div class="card-body text-center">
                <h4 class="card-title">Control de personas</h4>
                <p class="card-text">Puede modificar crear o borrar los personas que esten registrado.</p>
                <button id="add__new__list" type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg"><i
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $user->PersonasNombreCompleto }} </td>
                                <td>{{ $user->PersonasTel }} </td>
                                <td>{{ $user->PersonasTipoDoc }} </td>
                                <td>{{ $user->PersonasTitulo }} </td>
                                <td>{{ $user->PersonasEspecialidad }} </td>
                                <td>
                                    <div class="btn btn-sm btn-primary" userIdUpdate="{{ $user->PersonasID }}"><i class="far fa-edit"></i>
                                        Actualizar</div>
                                </td>
                                <td>
                                    <div class="btn btn-sm btn-danger" userIdDelete="{{ $user->PersonasID }}"><i class="fas fa-info-circle"></i>Eliminar</div>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
