                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size: 13px">{{ $recurso->PersonasNombreCompleto }} </td>
                                <td style="font-size: 13px">{{ $recurso->PersonasTel }} </td>
                                <td style="font-size: 13px">{{ $recurso->PersonasTitulo }} </td>
                                <td style="font-size: 13px">{{ $recurso->PersonasDocumento }} </td>
                                <td style="font-size: 13px">{{ $recurso->PersonasTipoDoc }} </td>
                                <td style="font-size: 13px">{{ $recurso->PersonasFechaIngreso }} </td>
                                <td style="font-size: 13px">
                                    <div class="btn btn-sm btn-primary" userIdUpdate="{{ $recurso->PersonasID }}"><i class="far fa-edit"></i>
                                        Actualizar</div>
                                </td>
                                <td style="font-size: 13px">
                                    <div class="btn btn-sm btn-danger" userIdDelete="{{ $recurso->PersonasID }}">Eliminar</div>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
