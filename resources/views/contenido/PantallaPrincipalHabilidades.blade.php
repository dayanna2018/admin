                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px">
                                    <div class="btn btn-sm btn-primary" userIdUpdate="{{ $user->HabilidadesID }}"><i class="far fa-edit"></i>
                                        Actualizar</div>
                                </td>
                                <td style="font-size: 12px">
                                    <div class="btn btn-sm btn-danger" userIdDelete="{{ $user->HabilidadesID }}">Retiro</div>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
